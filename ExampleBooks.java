...
class ExampleBooks {
    ...
    Book theReturnOfTheKing = new Book("The Return of the King", tolkien, 8);

    String authorText = this.tolkien.toText();
    String theTwoTowersText = this.theTwoTowers.toText();
}